...
import { binanceWeb3Wallet } from "../src/components/binanceWeb3Wallet"
import { okx1Wallet } from "../src/components/okx1Wallet"
...
const sei = {
    id: 713715,
    name: "Sei",
    iconUrl: "https://s3.coinmarketcap.com/static-gravity/image/992744cfbd5e40f5920018ee7a830b98.png",
    iconBackground: "#fff",
...
const config = getDefaultConfig({
    ...
    chains: [
        ...
        base,
        manta,
        ...(process.env.NEXT_PUBLIC_ENABLE_TESTNETS === "true" ? [sepolia, mantaSepoliaTestnet] : []),
    ],
    wallets: [
        ...wallets,
        {
            groupName: "Other",
            wallets: [...otherWallets, okx1Wallet, binanceWeb3Wallet],
        },
    ],
    ssr: true,
})
...
const DisclaimerDemo: DisclaimerComponent = ({ Link, Text }) => {
    return (
        <Text>
            By connecting, you agree to this demo&apos;s <Link href={RAINBOW_TERMS}>Terms of Service</Link> and
            acknowledge you have read and understand our <Link href={RAINBOW_TERMS}>Disclaimer</Link>
        </Text>
    )
}
...
const accentColors = ["blue", "green", "orange", "pink", "purple", "red", "custom"] as const
...
function RainbowKitApp({
    ...
    const currentTheme = (themes.find(({ name }) => name === selectedThemeName) ?? themes[0]).theme
                            ...
                            >
                                ...
                                <table cellSpacing={12}>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <label htmlFor="authEnabled" style={{ userSelect: "none" }}>
                                                    authentication
                                                </label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <label htmlFor="showRecentTransactions" style={{ userSelect: "none" }}>
                                        ...
                                        <tr>
                                            <td>
                                                <label htmlFor="coolModeEnabled" style={{ userSelect: "none" }}>
                                                    coolMode
                                                </label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <label htmlFor="showDisclaimer" style={{ userSelect: "none" }}>
                                                    disclaimer
                                                </label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <label htmlFor="customAvatar" style={{ userSelect: "none" }}>
                                                    avatar
                                                </label>
                                            </td>
                                            <td>
                                            ...
                                            {overlayBlurs.map((overlayBlur) => (
                                                <label key={overlayBlur} style={{ userSelect: "none" }}>
                                                    <input
                                                        ...
                                                        name="overlayBlur"
                                                        onChange={(e) => setOverlayBlur(e.target.value as OverlayBlur)}
                                                        type="radio"
                                                        value={overlayBlur}
                                                    />{" "}
                                                    {overlayBlur}
